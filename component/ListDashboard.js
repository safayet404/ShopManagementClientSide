                ...
                <Col className="text-center animated zoomIn p-1" sm={6} xs={6} md={6} lg={6}>
                  <Card>
                    <Card.Body>
                      ...
                      <h6 className="count-tile">Total Transaction</h6>
                    </Card.Body>
                  </Card>
                </Col>
                ...
                <Col className="text-center animated zoomIn p-1" sm={6} xs={6} md={6} lg={6}>
                  <Card>
                    <Card.Body>
                      ...
                      <h6 className="count-tile">Total Icome</h6>
                    </Card.Body>
                  </Card>
                </Col>
                ...
                <Col className="text-center animated zoomIn p-1" sm={6} xs={6} md={6} lg={6}>
                  <Card>
                    <Card.Body>
                      ...
                      <h6 className="count-tile">Total Category</h6>
                    </Card.Body>
                  </Card>
                </Col>
                ...
                <Col className="text-center animated zoomIn p-1" sm={6} xs={6} md={6} lg={6}>
                  <Card>
                    <Card.Body>
                      ...
                      <h6 className="count-tile">Total Product</h6>
                    </Card.Body>
                  </Card>
                </Col>
